...
DELIMITER $$
CREATE PROCEDURE Clients_Add(IN CategoryId INT, IN LastName NVARCHAR(100), IN FirstName NVARCHAR(100), IN DNI CHAR(8), IN Email NVARCHAR(100), IN Address NVARCHAR(500))
BEGIN
	INSERT INTO clients
		(categoryId, lastName, firstName, dni, email, address)
	VALUES
		(CategoryId, LastName, FirstName, DNI, Email, Address);
END$$
DELIMITER ;
